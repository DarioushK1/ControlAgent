...
import json
from util import loop_shaping, feedback_prompt, check_stability
...
class first_ord_unstable_Design:
    ...
    def handle_task(self, system, thresholds, task_requirement, scenario, trial):
        ...
        prompt = overall_instruction_RHP_Pole_PI
        ...
        output_dir = os.path.join(self.base_output_dir, f"first_ord_unstable//trial_{trial}")
