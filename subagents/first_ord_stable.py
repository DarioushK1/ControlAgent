...
class first_ord_stable_Design:
    ...
    def handle_task(self, system, thresholds, task_requirement, scenario, trial):
        ...
        print(f"Handling controller design for system {system['id']} scenario {scenario} trial {trial}.\n")

        # Construct the design prompt
        
        prompt = overall_instruction_PI
        ...
        output_dir = os.path.join(self.base_output_dir, f"first_ord_stable_{scenario}/trial_{trial}")
