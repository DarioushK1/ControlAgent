...
def process_dataset(file_path, num_trial):
    ...
    for trial in range(1,num_trial+1):
        for system in dataset:  # Loop through first two systems; adjust as necessary
            ...
            response = central_agent.assign_task(system, prompt, thresholds, scenario, trial)
            print(f"Response for dataset {file_path} trial {trial} and system {system['id']}:\n{response}\n")
...
if __name__ == "__main__":
    ...
    for dataset_file in dataset_files:
        ...
        process_dataset(dataset_file, num_trial=args.num_trial)
