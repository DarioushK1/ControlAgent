...
class CentralAgentLLM:
    ...
    def assign_task(self, system, input_prompt, thresholds, scenario, trial):
        ...
        if agent_number in self.sub_agents:
            ...
            response = sub_agent.handle_task(system, thresholds, parsed_response['Task Requirement'], scenario, trial)
        else:
